...
function Content({ positionName, companyName, extraComments, todayDate }) {
  ...
  const paragraph3 = `I have previous experience in managing projects and have made important decisions to help navigate my team to reach its goals.  As a former Chemical Data Scientist, I have experience in reliably working with confidential and critical data, and work extremely well under pressure, with a team and individually. I believe I will transition to your company very seamlessly, and hit the ground running to deliver results very quickly.
  `
